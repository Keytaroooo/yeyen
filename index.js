...
const vcard = 'BEGIN:VCARD\n'
            ...
            + 'FN:keytaroooo\n'
            + 'ORG: OwnerBot;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=628997033211:+62 899-7033-211\n' 
            + 'END:VCARD'
prefix = '.' 
blocked = []   
limitawal = 1000
...
/******** OWNER NUMBER**********/
const ownerNumber = ['628997033211@s.whatsapp.net','6281390199407@s.whatsapp.net']   
const pacarNumber = ["628137@s.whatsapp.net"]  
/************************************/
...
////////////////////
        ...
        case 'info':
                if (!isRegistered) return reply( ind.noregis())
            if (isBanned) return reply('```kebanned `')
				    costum('[❗] LOADING!', text, tescuk, ari)
                    me = ara.user
...
`
		...
		case 'request':
					...
					ara.sendMessage('628997033211@s.whatsapp.net', options, text, {quoted: mek})
